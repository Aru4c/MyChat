                ...
                if(!image.equals("default_profile"))
                {
                    ...
                    Picasso.get().load(image).networkPolicy(NetworkPolicy.OFFLINE)
                        ...
                        public void onError(Exception e) {
                            Picasso.get().load(image).placeholder(R.drawable.default_profile).into(settingsDisplayProfileImage);
                        }
                    });
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SettingsActivity.this, "Error occurred while uploading your profile image.", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                        }
                    }
                });
